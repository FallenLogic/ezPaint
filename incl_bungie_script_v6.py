...
fortnite = True  # Fortnite Battle Pass
...
def swjs_fixups(act_obj,):  # Hide this if not working with it more then 2000 lines fuck SW JFO and JS for some many facial bones
    ...
    # Only use with direct rips from Star Wars: Jedi Series through umodel!

    #act_obj.scale = (38.5, 38.5, 38.5)

    # Only use with direct rips from Star Wars: Jedi Series through umodel!

    # Only use with direct rips from Star Wars: Jedi Fallen Order with unique skeletons through umodel!

    #act_obj.scale = (37.5, 37.5, 37.5)
...
def fortnite_fixups(act_obj):
    ...
    # Only use with female fortnite models
    act_obj.scale = (44, 44, 44)
    # Only use with female fortnite models

    # Only use with male fortnite models
